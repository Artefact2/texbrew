...
\newcommand*{\hbSBsubsec}[1]{\color{chapter}\Huge\mreaves#1\vspace*{-7pt}}
\newcommand*{\hbSBsubsubsec}[1]{\color{chapter}\LARGE\scaly\scshape\noindent\begin{minipage}{\linewidth}#1\vspace*{1pt}\rule[\baselineskip]{\linewidth}{1pt}\end{minipage}\vspace*{-\baselineskip}\vspace*{3pt}}
