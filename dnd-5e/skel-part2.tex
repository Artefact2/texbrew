\renewcommand*{\hbPartCover}{assets/samples/part-cover2}
\renewcommand*{\hbPartSubcover}{assets/samples/part-cover4}
\part{Dolor Sit Amet}

\chapter{Pretium justo}

\hbLettrine{V}{ivamus eu dolor.} \lipsum[1-2]
...
\hbLettrined{N}{ec ultricies.} \lipsum[1-2]
