...
\NewEnviron{phNote}{%
  ...
  \end{textblock*}%
  \begin{textblock*}{\columnwidth}(\zx{\phNotePos}-\parindent+\phNoteBoxWidth-\phNoteBW,\zy{\phNotePos}-\phNoteBoxHeight)
...
\NewEnviron{phNote2}{%
  ...
  \sbox{\phNoteBox}{%
    \colorbox{white}{%
      \hspace*{\phNotePadding}\begin{minipage}[b]{\columnwidth-2\phNotePadding-2\phNoteRW-2\fboxsep}%
        \setlength{\parskip}{\phNoteCurparskip}
        \setlength{\parindent}{\phNoteCurparindent}
        \noindent\scaly\small\BODY
      \end{minipage}%
