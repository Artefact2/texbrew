...
% Subsections
\newcommand{\ruledsubsec}[1]{\color{chapter}\Huge\mreaves\noindent\begin{minipage}{\columnwidth}#1\color{subsecrule}\vspace*{1pt}\rule[\baselineskip]{\columnwidth}{1pt}\end{minipage}\vspace*{-\baselineskip}\vspace*{-2pt}}
...
\renewcommand*{\cftpartafterpnum}{\vspace{1pt}\\*\noindent\hspace*{-\cftpartnumwidth}\hspace*{-32pt}\color{subsecrule}\vspace*{1pt}\rule[\baselineskip]{\columnwidth}{1pt}\vspace*{-\baselineskip}\vspace{-2pt}} % XXX: -32pt source?
